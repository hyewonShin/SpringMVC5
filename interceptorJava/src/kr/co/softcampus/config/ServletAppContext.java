...
import kr.coft.campus.interceptor.TestInterceptor1;
import kr.coft.campus.interceptor.TestInterceptor2;
import kr.coft.campus.interceptor.TestInterceptor3;
import kr.coft.campus.interceptor.TestInterceptor4;
import kr.coft.campus.interceptor.TestInterceptor5;
import kr.coft.campus.interceptor.TestInterceptor6;
import kr.coft.campus.interceptor.TestInterceptor7;
import kr.coft.campus.interceptor.TestInterceptor8;
...
public class ServletAppContext implements WebMvcConfigurer{
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		reg6.addPathPatterns("/*");   // 한덩어리 아무거나 인터셉터 하겠다. 
		
		reg7.addPathPatterns("/sub1/*");
		
		reg8.addPathPatterns("/**"); // 여러덩어리 있는 주소 인터셉터 하겠다. 
		reg8.excludePathPatterns("/*");// 덩어리 하나만 있는건 제외하겠다는 뜻. 
	}
	
	
}

// preHandle은 순서대로 호출되고, postHandle/afterCompletion은 역순으로 호출된다.
